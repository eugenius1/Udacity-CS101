...
print stirling(1,1) == 1
print stirling(2,1) == 1
print stirling(2,2) == 1
print stirling(2,3) ==0

print stirling(3,1) == 1
print stirling(3,2) == 3
print stirling(3,3) == 1

print stirling(4,1) == 1
print stirling(4,2) == 7
print stirling(4,3) == 6
print stirling(4,4) == 1

print stirling(5,1) == 1
print stirling(5,2) == 15
print stirling(5,3) == 25
print stirling(5,4) == 10
print stirling(5,5) == 1

print stirling(20,15) == 452329200
